...
const TEST_MESSAGES: MessageItem[] = [
  { id: '1', type: 'user', content: 'Tell me about the name Aurora' },
  {
    ...
    names: [{ name: 'Aurora', sex: 'F', rank: 704, origin: 'Latin', year_peak: 2024, vibe_names_f: [], vibe_names_m: [] }],
  },
  { id: '3', type: 'user', content: 'Southern, vintage one-syllable boy names' },
  {
    ...
    names: [
      { name: 'Joel', sex: 'M', rank: 248, origin: 'Hebrew', year_peak: 1977, vibe_names_f: [], vibe_names_m: [] },
      { name: 'Jude', sex: 'M', rank: 182, origin: 'Hebrew', year_peak: 2022, vibe_names_f: [], vibe_names_m: [] },
      { name: 'Levi', sex: 'M', rank: 29, origin: 'Hebrew', year_peak: 2023, vibe_names_f: [], vibe_names_m: [] },
      { name: 'Ezra', sex: 'M', rank: 37, origin: 'Hebrew', year_peak: 2022, vibe_names_f: [], vibe_names_m: [] },
      { name: 'Ira', sex: 'M', rank: 690, origin: 'Hebrew', year_peak: 1918, vibe_names_f: [], vibe_names_m: [] },
      { name: 'Amos', sex: 'M', rank: 891, origin: 'Hebrew', year_peak: 1918, vibe_names_f: [], vibe_names_m: [] },
    ],
  },
